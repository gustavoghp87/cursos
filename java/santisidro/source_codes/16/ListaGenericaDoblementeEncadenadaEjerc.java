...
public class ListaGenericaDoblementeEncadenadaEjerc {
	class Nodo {
		 int info;
		 Nodo ant,sig;
		 }
		 ...
		 public ListaGenericaDoblementeEncadenadaEjerc () {
		 raiz=null;
		 }
		 ...
		 ListaGenericaDoblementeEncadenadaEjerc lg=new ListaGenericaDoblementeEncadenadaEjerc();
