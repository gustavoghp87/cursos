...
public class GraficoTartas extends JFrame {
	 ...
	 public static void main(String[] args) {
		 EventQueue.invokeLater(new Runnable() {
			 public void run() {
				 try {
					 GraficoTartas frame = new GraficoTartas();
...
// Crear una aplicación que solicite el ingreso de tres valores por teclado que representan las
// cantidades de votos obtenidas por tres partidos políticos. Luego mostrar un gráfico de tartas: