...
public class java012_02 extends JFrame implements ActionListener
{
	...
	public java012_02() {
		setLayout(null);
		label1 = new JLabel("Ingrese n�mero 1:");
		label1.setBounds(10,10,150,30);
		add(label1);
		label1 = new JLabel("Ingrese n�mero 2:");
...
//Confeccionar un programa que permita ingresar dos n�meros en controles de tipo JTextField,
//luego sumar los dos valores ingresados y mostrar la suma en la barra del t�tulo del control JFrame.