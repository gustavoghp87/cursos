...
public class java009_7 {
	public static void main(String[] ar) {
		...
		cad1=teclado.nextLine();       //nextLine permite espacios en blanco
...
//Confeccionar una clase que solicite el ingreso de dos String y luego emplee los métodos más
//comunes de la clase String.