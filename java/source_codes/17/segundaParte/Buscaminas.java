...
// Desarrollar el juego del Buscaminas. Definir una matriz de 10*10 de JButton y disponer
// una 'b' para las bombas (10 diez) un cero en los botones que no tienen bombas en su
// perímetro, un 1 si tiene una bomba en su perímetro y así sucesivamente. Cuando se
// presiona un botón si hay un cero proceder en forma recursiva a destapar los botones
// que se encuentran a sus lados. Disponer el mismo color de frente y fondo de los
